 ...
 */
var NetworkTimestamp = /** @class */ (function () {
    /**
     * Creates a timestamp.
     * @param {number} timestamp Raw network timestamp.
     */
    function NetworkTimestamp(timestamp) {
        this.timestamp = BigInt(timestamp);
    }
    Object.defineProperty(NetworkTimestamp.prototype, "isEpochal", {
        /**
     ...
     */
    NetworkTimestamp.prototype.addSeconds = function () {
     ...
     */
    NetworkTimestamp.prototype.addMinutes = function (count) {
     ...
     */
    NetworkTimestamp.prototype.addHours = function (count) {
     ...
     */
    NetworkTimestamp.prototype.toString = function () {
 ...
 */
var NetworkTimestampDatetimeConverter = /** @class */ (function () {
    /**
     ...
     */
    function NetworkTimestampDatetimeConverter(epoch, timeUnits) {
        this.epoch = epoch;
        this.timeUnits = {
            hours: 60 * 60 * 1000,
            minutes: 60 * 1000,
     ...
     */
    NetworkTimestampDatetimeConverter.prototype.toDatetime = function (rawTimestamp) {
     ...
     */
    NetworkTimestampDatetimeConverter.prototype.toDifference = function (referenceDatetime) {
    ...
    return NetworkTimestampDatetimeConverter;
}());
module.exports = { NetworkTimestamp: NetworkTimestamp, NetworkTimestampDatetimeConverter: NetworkTimestampDatetimeConverter };
