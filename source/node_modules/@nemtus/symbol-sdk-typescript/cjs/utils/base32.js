...
// region encode
var encodeBlock = function (input, inputOffset, output, outputOffset) {
...
var decodeChar = function (c) {
    ...
    if (undefined !== decodedChar)
        return decodedChar;
    throw Error("illegal base32 character ".concat(c));
};
var decodeBlock = function (input, inputOffset, output, outputOffset) {
...
var base32 = {
    ...
    encode: function (data) {
        if (0 !== data.length % DECODED_BLOCK_SIZE)
            throw Error("decoded size must be multiple of ".concat(DECODED_BLOCK_SIZE));
    ...
    decode: function (encoded) {
        if (0 !== encoded.length % ENCODED_BLOCK_SIZE)
            throw Error("encoded size must be multiple of ".concat(ENCODED_BLOCK_SIZE));
