...
class Network extends BasicNetwork {
    ...
    constructor(name, identifier, epochTime) {
        super(name, identifier, new NetworkTimestampDatetimeConverter(epochTime, 'seconds'), () => keccak_256.create(), (addressWithoutChecksum, checksum) => new Address(new Uint8Array([...addressWithoutChecksum, ...checksum])), Address, NetworkTimestamp);
    }
}
